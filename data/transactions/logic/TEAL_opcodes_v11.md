...
- **Cost**: BN254g1=125; BN254g2=170; BLS12_381g1=205; BLS12_381g2=290; Ed25519=100;
- Availability: v11
...
| 4     | Ed25519     | Twisted Edwards Curve25519. Points encoded as 32 bytes of Y and with lowest bit (parity) of X. |

For BN254 and BLS12_381 A and B are curve points in affine representation: field element X concatenated with field element Y. Field element `Z` is encoded as follows.
...
- **Cost**: BN254g1=1810; BN254g2=3430; BLS12_381g1=2950; BLS12_381g2=6530; Ed25519=100;
- Availability: v11
...
- **Cost**: BN254g1=3600 + 90 per 32 bytes of B; BN254g2=7200 + 270 per 32 bytes of B; BLS12_381g1=6500 + 95 per 32 bytes of B; BLS12_381g2=14850 + 485 per 32 bytes of B; Ed25519=100 + 100 per 32 bytes of B
- Availability: v11
...
- **Cost**: BN254g1=20; BN254g2=3100; BLS12_381g1=1850; BLS12_381g2=2340; Ed25519=100
- Availability: v11
...
- **Cost**: BN254g1=630; BN254g2=3300; BLS12_381g1=1950; BLS12_381g2=8150, Ed25519=100
- Availability: v11
